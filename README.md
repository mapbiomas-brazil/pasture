...
* [Access this link](https://code.earthengine.google.com/4f60cd17f918f1370b58273d979b8872) and, if desired, change the parameters of ***year***, ***landsatWRSPath***, ***landsatWRSRow***, ***my_folder***. After that you can click in **Run** and export your result in **Task**.
